<template>
  <div class="bg-[#ECF0F2] min-h-screen w-screen flex flex-col overflow-hidden">
    ...
    <div class="flex flex-1 py-20 mx-20">
      <!-- Sidebar -->
      <div class="bg-white rounded-lg h-fit" style="box-shadow: 2px 2px 4px #a4a4a4">
        <div class="pl-10 pr-20 py-3">
          <h3 class="text-[#3A6351] font-semibold text-2xl mb-4">Manage</h3>
          <nav>
            <ul class="flex flex-col gap-5">
              <li class="flex gap-4 items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="#3A6351" viewBox="0 0 16 16">
                  <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0" />
                  <path fill-rule="evenodd"
                    d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1" />
                </svg>
                <NuxtLink to="/admininformation" class="text-[#3A6351] text-sm" active-class="underline font-bold">
                  Information
                </NuxtLink>
              </li>
              <li class="flex gap-4 items-center">
                ...
                <NuxtLink to="/staffmanagement" class="text-[#3A6351] text-sm" active-class="underline font-bold">Staff
                  Management</NuxtLink>
              </li>
              <li class="flex gap-4 items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="#3A6351" viewBox="0 0 16 16">
                ...
                <NuxtLink to="/customermanagement" class="text-[#3A6351] text-sm" active-class="underline font-bold">
              ...
              <li class="flex gap-4 items-center">
                ...
                <NuxtLink to="/tablemanagement" class="text-[#3A6351] text-sm" active-class="underline font-bold">Table
                  Management</NuxtLink>
              </li>
              <li class="flex gap-4 items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="#3A6351"
                ...
                <NuxtLink to="/promotion" class="text-[#3A6351] text-sm" active-class="underline font-bold">Promotion
                  Management</NuxtLink>
              </li>
              <li class="flex gap-4 items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="#3A6351" viewBox="0 0 16 16">
                ...
                <NuxtLink to="/bookingmanagement" class="text-[#3A6351] text-sm" active-class="underline font-bold">
              ...
              <li class="flex gap-4 items-center">
                ...
                <NuxtLink to="/billmanagement" class="text-[#3A6351] text-sm" active-class="underline font-bold">Bill
                  Management</NuxtLink>
              </li>
              <li class="flex gap-4 items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="#3A6351" viewBox="0 0 16 16">
                ...
                <NuxtLink to="/menumanagement" class="text-[#3A6351] text-sm" active-class="underline font-bold">Menu
                  Management</NuxtLink>
              </li>
              <li class="flex gap-4 items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="#3A6351" viewBox="0 0 16 16">
                ...
                <NuxtLink class="text-[#3A6351] text-sm" active-class="underline font-bold" to="/message">Message
                </NuxtLink>
              </li>
              <li class="flex gap-4 items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="#3A6351" viewBox="0 0 16 16">
                ...
                <NuxtLink class="text-[#3A6351] text-sm" active-class="underline font-bold" to="/analytics">Analytics
                </NuxtLink>
              </li>
              <li @click="logOut" class="flex gap-4 items-center">
                ...
                <button class="text-[#3A6351] text-sm">Logout</button>
              </li>
            </ul>
          </nav>
        </div>
    ...
    <!-- Footer -->
    <div class="bg-[#3A6351] h-fit text-white">
